...
uses
  ...
  sysutils,dcsystem,dcdreamlib,consts,dcconsts,system.types;
...
var arrays:TDCProcArrays;
begin
  inherited;
  ///green
  arrays:=self.ProcArrays;
  With arrays do
  begin
  ...
  self.ProcArrays:=arrays;


//  //rem because it didnt compile
//  With ProcArrays do
//  begin
//    FSetValueProcs[akMethod].AsSetValue   :=SetValueAsMethod;
//    FGetValuesProcs[akMethod].AsGetValues :=GetValuesAsMethod;
...
const
  DCDsgnPropClassMap: array[TypInfo.TTypeKind] of TDCDsgnPropertyEditorClass = (
    ...
    nil,                      // tkDynArray
    TDCDsgnStringProperty,    // tkUString
    TDCDsgnClassProperty,     // ttkClassRef
    nil,                       //tkPointer
    TDCDsgnMethodProperty    // tkProcedure
    );
    {tkUString,
