...
begin
  ...
  ShiftState := [ssDouble];
  wParam:=Integer(@ComponentClass);
  //lParam:=Integer(ShiftState);
  lParam:=(PInteger(@ShiftState))^;

  BroadCastToNotifiers( Self, CM_PALETTECLICK, wParam, lParam );
  DesignerInsertClass := '';
  ResetSelection;
end;
