...
type
  ...
  TDelphiVer = (dvD2,dvC1,dvD3,dvC3,dvD4,dvC4,dvD5,dvC5,dvd6,dvC6,dvD7,dvD2006);

  TDelphiVers=set of TDelphiVer;

const

 cAllDelphiVers=[dvd2..dvd2006];
 ...
 cDCNativeVerDefine:Array[TDelphiVer] of String=(
  ...
  cDelphiVers : array[TDelphiVer] of string = ('D2', 'C1', 'D3', 'C3', 'D4', 'C4', 'D5', 'C5','D6', 'C6', 'D7','D2006');
  DelphiReqVer:Array[TDelphiVer] Of Integer =(-1{D2},-1{C1},$50053{D3},$30046{C3},$5006C{D4},$E000B{C4},-1{D5},-1{C5},-1{D6},-1{C6},-1{D7},-1{D2006});
...
begin
  case DelphiVer of
    ...
    dvD2006 : result := 'Software\Borland\BDS\4.0\Known Packages';
    else result := '';
  end;
end;
...
begin
  ...
  if basedir <> '' then
    begin
      ...
      If DelphiVer in [dvD7,dvd6,dvd5,dvc5,dvd2006] then
        result := result+
                  basedir +'Source\Decision Cube;' +
                  basedir +'Source\Property Editors;'+
                  basedir +'Source\WebMidas;';

      If DelphiVer in [dvd6, dvd7,dvd2006] then
        result := result+
      ...
      If DelphiVer in [dvd2006] then
        result := result+
                  basedir +'Source\win32\ComServers;' +
                  basedir +'Source\win32\ComServers\ie5;' +
                  basedir +'Source\win32\ComServers\office2k;' +
                  basedir +'Source\win32\ComServers\officexp;' +
                  basedir +'Source\win32\db;' +
                  basedir +'Source\win32\Decision Cube;' +
                  basedir +'Source\win32\IBX;' +
                  basedir +'Source\win32\Indy9;' +
                  basedir +'Source\win32\Internet;' +
                  basedir +'Source\win32\Property Editors;' +
                  basedir +'Source\win32\rtl;' +
                  basedir +'Source\win32\rtl\common;' +
                  basedir +'Source\win32\rtl\win;' +
                  basedir +'Source\win32\rtl\sys;' +
                  basedir +'Source\win32\Samples\source;' +
                  basedir +'Source\win32\soap;' +
                  basedir +'Source\win32\vcl;' +
                  basedir +'Source\win32\webmidas;' +
                  basedir +'Source\win32\WebSnap;' +
                  basedir +'Source\win32\xml;' ;
...
const
  ...
  ('delphi.cnt', 'bcb.cnt', 'delphi3.cnt', 'bcb3.cnt', 'delphi4.cnt','bcb4.cnt','delphi5.cnt','bcb5.cnt','delphi6.cnt', 'bcb6.cnt', 'd7.cnt', 'd2006.cnt');
...
const
  PackageExts : array[TDelphiVer] of string =
   ('', '', '.DPL', '.BPL', '.BPL', '.BPL', '.BPL', '.BPL','.BPL', '.BPL', '.BPL', '.BPL');
...
Begin
  ...
  Case DelphiVer Of
    dvD2,dvD3,dvD4,dvD5,dvd6, dvd7,dvd2006:
      Begin
