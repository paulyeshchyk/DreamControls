...
begin
 // fProcArrays.FEditProcs[akMethod].ProcWasUsed:=true;
...
var item:TDCProcArrayItem;
begin
//FProcArrays.FgetValueAtProcs[akMethod].asgetValueAt
  item:=FProcArrays.FGetValuesProcs[AccessKind];
  if not(assigned(item.AsGetValues)) then
      DCErrorAccessKind(ikGetValues,AccessKind) else
  begin
