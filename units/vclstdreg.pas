...
begin
  ...
  RegisterComponents({SPalAdditional}SPalStandard, [{TBitBtn,} TSpeedButton, //TMaskEdit,
    TStringGrid, {TDrawGrid, TImage, TShape,} TBevel, TScrollBox]);

  RegisterComponents({SPalWin32}SPalStandard, [{TTabControl, TPageControl,} TImageList{, TRichEdit,}
