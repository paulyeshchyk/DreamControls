...
type
  ...
  public
    ...
    procedure SetHintDelta(aDelta:Integer);//green  - изврат конечно..
                                          // fHintDelta не зануляется в каких-то случаях
  published
...
{-----------------------------------------------------------}
procedure TDCHint.SetHintDelta(aDelta:Integer);//green  - изврат конечно..
                                      // fHintDelta не зануляется в каких-то случаях
begin
  FHintDelta:=aDelta;
end;
...
begin
  ...
  begin
    ...
    ActivateHint(Rect(FHintRect.Left , FHintRect.Top + FHintDelta, FHintRect.Right , FHintRect.Bottom + FHintDelta), FCaption);
