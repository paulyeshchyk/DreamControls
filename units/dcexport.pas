...
//------------ Content & Index------------
  ...
  cRtfIdentChars : TCharSet =['A'..'Z','a'..'z','À'..'ß','à'..'ÿ','_', '*'];
  ...
  SRtfResWords  : Array[0 .. SMaxRtfResWors - 1] of ansistring = ( '\b' , '\blue', '\cell',
...
procedure _inc(var P : PAnsichar);
begin
  {$IFDEF DCMBCS}
...
begin
  ...
  FParser.FSourcePtr := Pansichar(Html);
end;
