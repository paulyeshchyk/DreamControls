...
uses
  classes , messages, sysutils,actnlist,System.Actions,
...
procedure DCEnumRegisteredActions(Proc: System.Actions.TEnumActionProc; Info: Pointer; const FrameworkType: string);
var
  i:integer;
begin
...
function  DCCreateAction(AOwner: TComponent; ActionClass: TBasicActionClass; const frameWorkType:String): TBasicAction;
begin
