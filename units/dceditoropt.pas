...
begin
  ...
  begin
    ...
    BeginEndPaintChk.Checked := moBeginEndPaint in Options;
...
begin
  ...
  if BeginEndPaintChk.Checked then
    Include(mo, moBeginEndPaint)
  else
    Exclude(mo, moBeginEndPaint);
