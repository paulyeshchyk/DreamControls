...
//    MaxValue   : integer;
  ...
  private
    ...
    function    GetBaseAddr : PAnsiChar;
//    function    GetBaseAddr : PChar;
  public
    function    Add(const s : string) : integer;
    property    BaseAddr : PAnsiChar read GetBaseAddr;
...
{    procedure CalcVMT(pti : PTypeDeclInfo);}
  ...
  protected
    ...
    function  GetParsedFileName:ansiString;override;
    ...
    function  GetErrorDesc : ansistring; override;

    Procedure DoFileConfirm( Var AFileName : ansiString; Var AConsiderEmpty : Boolean ); Override; // Dm.
  public
...
function TStringHolder.GetBaseAddr : PAnsiChar;
begin
...
function  TUnitParser.GetErrorDesc : ansistring;
begin
...
Procedure TUnitParser.DoFileConfirm( Var AFileName : ansiString; Var AConsiderEmpty : Boolean );
begin
  AConsiderEmpty := True;
...
begin
  ...
  while not (ParserEOF or IsTokenChar(ansiChar(CloseBracket))) do
    begin
...
function TUnitParser.GetParsedFileName:ansiString;
begin
  Result:=ansiString(ModuleInfo.ModuleFile)
end;
