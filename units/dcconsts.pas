...
const
  ...
  OPPKey = 'Software\Ascon\GulfStream\8.0\';
  SVarWSpaceFileName = 'WorkSpace\FileName';
  SVarWSpaceFilerID = 'WorkSpace\FilerID';
  SVarWSpaceRecent = 'WorkSpace\RecentInfos';
  SDreamControlsVersion = '1.0';
  SDreamRegKey = OPPKey+'Dream';  //;//'Software\AsconOPP\';
  SDefaultRegKey = SDreamRegKey+'\DesignerFIS ';// + SDreamControlsVersion;
