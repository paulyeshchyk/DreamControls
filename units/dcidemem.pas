...
type
  ...
  public
    ...
    constructor CreateNew(const FileName:TFileName;
                  const FilerID:TFilerID;Dummy:Integer;Aclassname:string='');override;
  end;
...
constructor TCustomMemoObject.CreateNew(const FileName:TFileName;const FilerID:TFilerID;Dummy:Integer;Aclassname:string='');
begin
  inherited;
  CreateSource;
...
constructor TClipboardIDEObject.CreateNew(const FileName:TFileName;
              const FilerID:TFilerID;Dummy:Integer;Aclassname:string='');
begin
