...
const
  ...
  { Character sets }
  cSyFirstIdentChars: TCharSet = ['A'..'Z', 'a'..'z', '_','À'..'ß','à'..'ÿ'];
  cSyOtherIdentChars: TCharSet = ['A'..'Z', 'a'..'z', '_', '0'..'9','À'..'ß','à'..'ÿ'];
  cSyHexDigits: TCharSet = ['0'..'9', 'A'..'F', 'a'..'f'];
  cSySymbolChars: TCharSet = [#33..#255] - ['A'..'Z', 'a'..'z', '_', '0'..'9','À'..'ß','à'..'ÿ'];
...
function TSyntaxParser.ColorString(const StrData: Ansistring; InitState: Integer;
