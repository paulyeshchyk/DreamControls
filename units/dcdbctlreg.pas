...
{$I dcprod.inc}
uses
  Classes, db, typinfo {$IFDEF USEBDE}{$ENDIF}, dialogs, controls, sysutils, dbctrls,
...
function GetTableExtension():String;//TableType:TTableType):String;
begin
//  case TableType of
//    ttParadox:
