...
const
  DefaultNewAppItem:  TIDEObjectClass = TDelphiApplication;
  DefaultNewFormItem: TIDEObjectClass = TDelphiFormObject;
  DefaultNewUnitItem: TIDEObjectClass = TDelphiUnitObject;
  DefaultNewDataItem: TIDEObjectClass = TDelphiDataModuleObject;
...
constructor TIDEFormMemoObject.CreateNew(const FileName:TFileName; const FilerID:TFilerID;Dummy:Integer;Aclassname:string='');
begin
  FFormObject:=GetFormObjectClass.CreateNew(FormFileName(FileName),FilerID,0,Aclassname);
  inherited;
  AfterCreate;
